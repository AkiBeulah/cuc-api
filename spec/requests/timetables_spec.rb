...
RSpec.describe "/timetables", type: :request do
  ...
  # TimetablesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get timetables_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Timetable" do
        expect {
          post timetables_url,
               params: { timetable: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Timetable" do
        expect {
          post timetables_url,
               params: { timetable: invalid_attributes }, as: :json
        }.to change(Timetable, :count).by(0)
      end

      it "renders a JSON response with errors for the new timetable" do
        post timetables_url,
             params: { timetable: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested timetable" do
        timetable = Timetable.create! valid_attributes
        patch timetable_url(timetable),
              params: { timetable: new_attributes }, headers: valid_headers, as: :json
        timetable.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested timetable" do
      timetable = Timetable.create! valid_attributes
      expect {
        delete timetable_url(timetable), headers: valid_headers, as: :json
      }.to change(Timetable, :count).by(-1)
    end
  end
end
